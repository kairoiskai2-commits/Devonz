...
type RouteFiles = {
  ...
  "routes/api.preview-proxy.$.ts": {
    id: "routes/api.preview-proxy.$";
    page: "/api/preview-proxy/*";
  };
  ...
  "routes/api.auto-deploy.ts": {
    id: "routes/api.auto-deploy";
    page: "/api/auto-deploy";
  };
...
type RouteModules = {
  ...
  "routes/api.auto-deploy-status": typeof import("./app/routes/api.auto-deploy-status.ts");
  ...
  "routes/api.auto-deploy": typeof import("./app/routes/api.auto-deploy.ts");
