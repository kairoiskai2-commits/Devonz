    ...
    <AnimatePresence>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <motion.div
          ...
          className={cn(
            'bg-veyra-elements-bg-depth-1 rounded-xl shadow-xl border border-veyra-elements-borderColor max-w-md w-full max-h-[80vh] flex flex-col',
            className,
          )}
        >
          {/* Header */}
          <div className="p-6 border-b border-veyra-elements-borderColor flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-blue-500/10 flex items-center justify-center">
                <div className="i-ph:git-branch size-6 text-blue-600" />
              </div>
              <div>
                <h3 className="text-lg font-semibold text-veyra-elements-textPrimary">Select Branch</h3>
            ...
            <button
              onClick={onClose}
              className="p-2 rounded-lg hover:bg-veyra-elements-background-depth-1 text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary transition-all"
            >
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center p-8 space-y-4">
                ...
                <p className="text-sm text-veyra-elements-textSecondary">Loading branches...</p>
              </div>
            ) : error ? (
              <div className="flex flex-col items-center justify-center p-8 space-y-4">
                ...
                {branches.length > 10 && (
                  <div className="p-4 border-b border-veyra-elements-borderColor">
                    <input
                      ...
                      className="w-full px-3 py-2 rounded-lg bg-veyra-elements-background-depth-1 border border-veyra-elements-borderColor text-veyra-elements-textPrimary placeholder-veyra-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-veyra-elements-borderColorActive"
                    />
                  </div>
                )}
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            selectedBranch === branch.name
                              ...
                              : 'bg-veyra-elements-background-depth-1 border-transparent hover:bg-veyra-elements-background-depth-2',
                          )}
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2 min-w-0">
                              <div className="i-ph:git-branch size-4 flex-shrink-0 text-veyra-elements-textSecondary" />
                              <span className="font-medium text-veyra-elements-textPrimary truncate">
                                {branch.name}
                              </span>
                          ...
                          <div className="text-xs text-veyra-elements-textSecondary mt-1 truncate">
          ...
          {!isLoading && !error && branches.length > 0 && (
            <div className="p-6 border-t border-veyra-elements-borderColor flex items-center justify-between">
