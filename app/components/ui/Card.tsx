...
function Card({ className, style, ref, ...props }: CardProps) {
  return (
    <div
      ref={ref}
      className={cn('rounded-lg border text-veyra-elements-textPrimary shadow-sm', className)}
      style={{
...
function CardTitle({
  ...
  return (
    <h3
      ...
      style={{ color: 'var(--veyra-elements-textPrimary)', ...style }}
      {...props}
    />
  );
}
...
function CardDescription({
  ...
  return (
    <p
      ...
      style={{ color: 'var(--veyra-elements-textSecondary)', ...style }}
      {...props}
    />
  );
}
