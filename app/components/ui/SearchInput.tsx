...
export function SearchInput({
  ...
  return (
    <div className={cn('relative flex items-center w-full', containerClassName)}>
      ...
      <div className={cn('absolute left-3 top-1/2 -translate-y-1/2 text-veyra-elements-textTertiary', iconClassName)}>
        {loading ? (
      ...
      <AnimatePresence>
        {hasValue && showClearButton && (
          <motion.button
            ...
            type="button"
            onClick={onClear}
            className="absolute right-3 top-1/2 -translate-y-1/2 text-veyra-elements-textTertiary hover:text-veyra-elements-textSecondary p-1 rounded-full hover:bg-veyra-elements-background-depth-2"
