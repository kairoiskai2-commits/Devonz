...
const ThoughtBox = ({ title, children }: PropsWithChildren<{ title: string }>) => {
  ...
  return (
    <div className="bg-veyra-elements-background-depth-2 shadow-sm rounded-lg border border-veyra-elements-borderColor">
      {/* Header — always visible, never scrolls away */}
      <div
        onClick={handleToggle}
        className="px-3 py-2 flex items-center gap-2 rounded-lg text-veyra-elements-textSecondary font-medium text-xs cursor-pointer select-none"
      >
