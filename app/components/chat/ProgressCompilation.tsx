...
const PHASE_COLORS: Record<string, string> = {
  idle: 'bg-veyra-elements-item-backgroundDefault text-veyra-elements-item-contentDefault',
      ...
      >
        <div
          className={cn(
            ...
            'p-1 rounded-lg text-veyra-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-veyra-elements-item-backgroundAccent hover:bg-veyra-elements-artifacts-backgroundHover"
...
const PlanPhaseBadge = ({ fromPhase, toPhase }: { fromPhase: string; toPhase: string }) => {
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.15 }}
    >
      <div className="i-ph:arrows-clockwise text-veyra-elements-item-contentDefault" />
      <span className="text-veyra-elements-item-contentDefault">{PHASE_LABELS[fromPhase] ?? fromPhase}</span>
      <div className="i-ph:arrow-right text-veyra-elements-item-contentDefault" />
...
const ReviewCycleIndicator = ({
  ...
  return (
    <motion.div
      ...
      transition={{ duration: 0.15 }}
    >
      <div className="i-ph:magnifying-glass text-veyra-elements-item-contentDefault" />
      <span className="text-veyra-elements-item-contentDefault">Review #{cycle.cycleNumber}</span>
      {errorCount > 0 && (
