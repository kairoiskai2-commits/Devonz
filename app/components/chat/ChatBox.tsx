...
export const ChatBox: React.FC<ChatBoxProps> = (props) => {
  ...
  return (
    <div
      ...
      style={{
        background: 'var(--veyra-chat-bg)',
        borderWidth: '1px',
        borderStyle: 'solid',
        borderColor: 'var(--veyra-chat-border)',
        boxShadow: '0 20px 25px -5px var(--veyra-chat-shadow)',
    ...
    >
      ...
      {props.selectedElement && (
        <div className="flex mx-1.5 gap-2 items-center justify-between rounded-lg rounded-b-none border border-b-none border-veyra-elements-borderColor text-veyra-elements-textPrimary flex py-1 px-2.5 font-medium text-xs">
      ...
      <div className={cn('relative shadow-xs border border-veyra-elements-borderColor backdrop-blur rounded-lg')}>
        <textarea
          ref={props.textareaRef}
          aria-label="Chat message input"
          className={cn(
            'w-full pl-4 pt-4 pr-16 outline-none resize-none text-veyra-elements-textPrimary placeholder-veyra-elements-textTertiary bg-transparent text-sm',
            'transition-all duration-200',
            'hover:border-veyra-elements-focus',
          )}
          onDragEnter={(e) => {
            e.preventDefault();
            e.currentTarget.style.border = '2px solid var(--veyra-elements-borderColorActive)';
          }}
          onDragOver={(e) => {
            e.preventDefault();
            e.currentTarget.style.border = '2px solid var(--veyra-elements-borderColorActive)';
          ...
          onDragLeave={(e) => {
            e.preventDefault();
            e.currentTarget.style.border = '1px solid var(--veyra-elements-borderColor)';
          }}
          onDrop={(e) => {
            e.preventDefault();
            e.currentTarget.style.border = '1px solid var(--veyra-elements-borderColor)';
            ...
            <div className="flex gap-1 items-center">
              ...
              >
                {props.enhancingPrompt ? (
                  <div className="i-svg-spinners:90-ring-with-bg text-veyra-elements-loader-progress text-xl animate-spin"></div>
                ) : (
                  <div className="i-veyra:stars text-xl"></div>
                )}
              </IconButton>
                ...
                <IconButton
                  ...
                  className={cn('transition-all flex items-center gap-1', {
                    'bg-veyra-elements-item-backgroundAccent text-veyra-elements-item-contentAccent':
                      isModelSelectorOpen,
                    'bg-veyra-elements-item-backgroundDefault text-veyra-elements-item-contentDefault':
                      !isModelSelectorOpen,
                  })}
              ...
              {/* Divider */}
              <div className="w-px h-4 bg-veyra-elements-borderColor mx-0.5" />
              ...
              >
                <div
                  className={cn(
                    ...
                    showMoreTools ? 'i-ph:x' : 'i-veyra:expand',
                  )}
                />
              </IconButton>
            </div>
