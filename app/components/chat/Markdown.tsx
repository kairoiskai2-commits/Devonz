      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__devonzSelectedElement__')) {
            ...
            return (
              <div className="bg-veyra-elements-background-depth-3 border border-veyra-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-veyra-elements-background-depth-2 px-2 py-1 rounded text-veyra-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-veyra-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-veyra-elements-textSecondary !bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor p-2 rounded">
          ...
          if (className?.includes('__devonzQuickAction__') || dataProps?.dataVeyraQuickAction) {
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            dataProps?.dataVeyraQuickAction === 'true'
          ) {
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-veyra-elements-item-backgroundAccent text-veyra-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
