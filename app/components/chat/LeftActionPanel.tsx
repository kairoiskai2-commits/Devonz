...
export function LeftActionPanel({ importChat }: LeftActionPanelProps) {
  ...
  const buttonBaseClass = cn(
    ...
    'border border-veyra-elements-borderColor hover:border-veyra-elements-borderColorActive',
    'h-10 px-4 py-2',
    'transition-all duration-200 ease-in-out',
    'rounded-lg text-sm font-medium',
    'hover:bg-veyra-elements-bg-depth-3',
  );
    ...
    <div className="grid grid-cols-3 gap-3 w-full max-w-xl items-stretch">
      ...
      <div className="flex h-10">
        <Button
          ...
          style={{ backgroundColor: 'var(--veyra-elements-bg-depth-3)', width: '100%', height: '100%' }}
        >
