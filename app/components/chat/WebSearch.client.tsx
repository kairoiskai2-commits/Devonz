...
export function WebSearch({ onSearchResult, disabled }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-veyra-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={cn(
            ...
            'rounded-lg border border-veyra-elements-borderColor bg-veyra-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={cn(
              ...
              'bg-veyra-elements-background-depth-1 text-veyra-elements-textPrimary',
