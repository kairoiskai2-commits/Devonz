...
import { detectProjectCommands, createCommandsMessage, escapeVeyraTags } from '~/utils/projectCommands';
    ...
    <>
      <Button
        ...
        className={cn(
          ...
          'border border-veyra-elements-borderColor hover:border-purple-500/50',
          'h-10 px-4 py-2 justify-center',
          'transition-all duration-200 ease-in-out',
          'hover:shadow-[0_0_12px_rgba(168,85,247,0.15)]',
          className,
        )}
        style={{ backgroundColor: 'var(--veyra-elements-bg-depth-3)', ...style }}
      ...
      {isDialogOpen && !selectedProvider && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div
            className="rounded-xl shadow-2xl border border-veyra-elements-borderColor max-w-md w-full"
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <button
                  ...
                  className="p-2 rounded-lg bg-transparent hover:bg-veyra-elements-bg-depth-3 text-gray-400 hover:text-white transition-all duration-200 hover:scale-105 active:scale-95"
                >
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full p-4 rounded-lg border border-veyra-elements-borderColor hover:border-purple-500/50 transition-all duration-200 text-left group hover:shadow-[0_0_15px_rgba(168,85,247,0.1)]"
                  style={{ backgroundColor: 'var(--veyra-elements-bg-depth-3)' }}
                >
      ...
      {isDialogOpen && selectedProvider === 'github' && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-950 rounded-xl shadow-xl border border-veyra-elements-borderColor dark:border-veyra-elements-borderColor w-full max-w-4xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b border-veyra-elements-borderColor dark:border-veyra-elements-borderColor flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-lg bg-blue-500/10 dark:bg-blue-500/20 flex items-center justify-center">
                  <div className="i-ph:github-logo size-6 text-blue-600 dark:text-blue-400" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-veyra-elements-textPrimary dark:text-veyra-elements-textPrimary">
              ...
              <button
                ...
                aria-label="Close dialog"
                className="p-2 rounded-lg bg-transparent hover:bg-veyra-elements-background-depth-1 dark:hover:bg-veyra-elements-background-depth-1 text-veyra-elements-textSecondary dark:text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary dark:hover:text-veyra-elements-textPrimary transition-all duration-200 hover:scale-105 active:scale-95"
              >
                <div className="i-ph:x size-5 transition-transform duration-200 hover:rotate-90" />
              </button>
            </div>
