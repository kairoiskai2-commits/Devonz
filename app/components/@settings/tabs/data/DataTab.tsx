...
// Create a custom hook to connect to the veyraHistory database
function useVeyraHistoryDB() {
...
export function DataTab() {
  // Use our custom hook for the veyraHistory database
  const { db, isLoading: dbLoading } = useVeyraHistoryDB();
  ...
  // Data operations hook with veyraHistory database
  const {
    isExporting,
    isImporting,
    isResetting,
    ...
    customDb: db || undefined, // Pass the veyraHistory database, converting null to undefined
  ...
  useEffect(() => {
    if (db) {
      logger.debug('Loading chats from veyraHistory database', {
        name: db.name,
        version: db.version,
              ...
              <Card>
                <CardHeader>
                  <div className="flex items-center mb-2">
                    ...
                    <CardTitle className="text-lg group-hover:text-veyra-elements-item-contentAccent transition-colors">
                      Export All Chats
                    </CardTitle>
                  </div>
                ...
                <CardFooter>
                  <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                    <Button
                      ...
                      size="sm"
                      className={cn(
                        'hover:text-veyra-elements-item-contentAccent hover:border-veyra-elements-item-backgroundAccent hover:bg-veyra-elements-item-backgroundAccent transition-colors w-full justify-center',
              ...
              <CardFooter>
                <motion.div whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }} className="w-full">
                  <Button
                    ...
                    variant="outline"
                    size="sm"
                    className="hover:text-veyra-elements-item-contentAccent hover:border-veyra-elements-item-backgroundAccent hover:bg-veyra-elements-item-backgroundAccent transition-colors w-full justify-center"
                  >
                    Download Backup
                  </Button>
                </motion.div>
