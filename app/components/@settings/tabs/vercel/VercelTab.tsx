            ...
            {connection.stats?.projects?.length ? (
              <div className="mb-4">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor rounded-lg p-3">
                    <div className="text-lg font-semibold text-veyra-elements-textPrimary">
                  ...
                  <div className="bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor rounded-lg p-3">
                    ...
                    <div className="text-xs text-veyra-elements-textSecondary">Live (READY)</div>
                  </div>
                  <div className="bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor rounded-lg p-3">
                    <div className="text-lg font-semibold text-veyra-elements-textPrimary">
                      {new Set(connection.stats.projects.map((p) => p.framework).filter(Boolean)).size}
                    </div>
                    <div className="text-xs text-veyra-elements-textSecondary">Frameworks</div>
                  </div>
                  <div className="bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor rounded-lg p-3">
                    <div className="text-lg font-semibold text-veyra-elements-textPrimary">
                    ...
                    <div className="text-xs text-veyra-elements-textSecondary">Domains</div>
                  </div>
                </div>
                ...
                {(() => {
                  ...
                  return (
                    <div className="mt-3 flex items-center gap-3 px-3 py-2 rounded-lg bg-veyra-elements-background-depth-2 border border-veyra-elements-borderColor text-xs text-veyra-elements-textSecondary">
                      {errorCount > 0 && (
            ...
            {connection.stats?.projects?.length ? (
              <div className="grid gap-3">
                {connection.stats.projects.map((project) => (
                  <div
                    key={project.id}
                    className="p-4 rounded-lg border border-veyra-elements-borderColor hover:border-veyra-elements-borderColorActive/70 transition-colors bg-veyra-elements-background-depth-1"
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        <h5 className="text-sm font-medium text-veyra-elements-textPrimary flex items-center gap-2">
                          <div className="i-ph:globe w-4 h-4 text-veyra-elements-borderColorActive" />
                          {project.name}
                        </h5>
                          ...
                          {project.targets?.production?.alias && project.targets.production.alias.length > 0 ? (
                            <>
                              <a
                                ...
                                className="hover:text-veyra-elements-borderColorActive underline"
                              >
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {project.framework && (
                          <div className="text-xs text-veyra-elements-textSecondary px-2 py-1 rounded-md bg-veyra-elements-background-depth-2">
                            <span className="flex items-center gap-1">
                    ...
                    <div className="flex items-center flex-wrap gap-1 mt-3 pt-3 border-t border-veyra-elements-borderColor">
        ...
        <div className="p-6 space-y-6">
          {!connection.user ? (
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm text-veyra-elements-textSecondary mb-2">Personal Access Token</label>
                <input
                  type="password"
                  autoComplete="off"
                  spellCheck={false}
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-4 bg-veyra-elements-background-depth-1 dark:bg-veyra-elements-background-depth-1 rounded-lg">
                  <img
                    ...
                    alt="User Avatar"
                    className="w-12 h-12 rounded-full border-2 border-veyra-elements-borderColorActive"
                  />
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-veyra-elements-textPrimary">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="p-3 bg-veyra-elements-background-depth-1 rounded-lg border border-veyra-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      <div className="i-ph:buildings w-4 h-4 text-veyra-elements-item-contentAccent" />
                      <span className="text-xs font-medium text-veyra-elements-textPrimary">Projects</span>
                    </div>
                  ...
                  <div className="p-3 bg-veyra-elements-background-depth-1 rounded-lg border border-veyra-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-veyra-elements-textPrimary">Domains</span>
                    </div>
                    <div className="text-sm text-veyra-elements-textSecondary">
                  ...
                  <div className="p-3 bg-veyra-elements-background-depth-1 rounded-lg border border-veyra-elements-borderColor">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="text-xs font-medium text-veyra-elements-textPrimary">Usage</span>
                    </div>
                    <div className="text-sm text-veyra-elements-textSecondary">
