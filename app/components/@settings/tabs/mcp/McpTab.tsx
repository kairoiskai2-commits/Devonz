    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <section aria-labelledby="server-status-heading">
        <div className="flex justify-between items-center mb-3">
          <h2 className="text-base font-medium text-veyra-elements-textPrimary">MCP Servers Configured</h2>{' '}
          <button
            onClick={checkServerAvailability}
            disabled={isCheckingServers || !parsedConfig || serverEntries.length === 0}
            className={cn(
              'px-3 py-1.5 rounded-lg text-sm',
              'bg-veyra-elements-background-depth-3 hover:bg-veyra-elements-background-depth-4',
          ...
          >
            {isCheckingServers ? (
              <div className="i-svg-spinners:90-ring-with-bg w-3 h-3 text-veyra-elements-loader-progress animate-spin" />
            ) : (
      ...
      <section aria-labelledby="config-section-heading">
        <h2 className="text-base font-medium text-veyra-elements-textPrimary mb-3">Configuration</h2>

        <div className="space-y-4">
          <div>
            <label htmlFor="mcp-config" className="block text-sm text-veyra-elements-textSecondary mb-2">
              Configuration JSON
            </label>
            <textarea
              id="mcp-config"
              ...
              className={cn(
                ...
                'border',
                error ? 'border-veyra-elements-icon-error' : 'border-veyra-elements-borderColor',
                'text-veyra-elements-textPrimary',
                'focus:outline-none focus:ring-1 focus:ring-veyra-elements-focus',
              )}
            />
          </div>
          <div>{error && <p className="mt-2 mb-2 text-sm text-veyra-elements-icon-error">{error}</p>}</div>
          <div>
            <label htmlFor="max-llm-steps" className="block text-sm text-veyra-elements-textSecondary mb-2">
          ...
          <div className="mt-2 text-sm text-veyra-elements-textSecondary">
            ...
            <a
              ...
              className="text-veyra-elements-link hover:underline inline-flex items-center gap-1"
            >
      ...
      <div className="flex flex-wrap justify-between gap-3 mt-6">
        <button
          ...
          className="px-4 py-2 rounded-lg text-sm border border-veyra-elements-borderColor
                    bg-veyra-elements-background-depth-2 text-veyra-elements-textSecondary
