...
export default function ProjectMemoryTab() {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        {/* Section Switcher */}
        <div className="flex items-center gap-1 p-1 rounded-lg bg-veyra-elements-background-depth-2 w-fit">
          <button
            onClick={() => setActiveSection('project')}
            className={cn(
              'px-3 py-1.5 text-xs rounded-md font-medium transition-colors duration-200',
              activeSection === 'project'
                ? 'bg-veyra-elements-button-primary-background text-veyra-elements-button-primary-text'
          ...
          >
            <span className="flex items-center gap-1.5">
              ...
              Agent Memory
              {totalEntries > 0 && (
                <span className="ml-1 px-1.5 py-0 text-[10px] rounded-full bg-veyra-elements-item-contentAccent/15 text-veyra-elements-item-contentAccent font-semibold">
                  {totalEntries}
                </span>
              )}
            </span>
        ...
        {activeSection === 'project' && (
          <>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-medium text-veyra-elements-textPrimary">Project Memory</h3>
                  {fileExists ? (
            ...
            >
              <h4 className="text-sm font-medium text-veyra-elements-textPrimary mb-2 flex items-center gap-2">
                <div className="i-ph:lightbulb w-4 h-4 text-veyra-elements-item-contentAccent" />
                What can you put in Project Memory?
              </h4>
              <ul className="text-sm text-veyra-elements-textSecondary space-y-1 list-disc list-inside">
            ...
            <div className="flex flex-col gap-3">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-veyra-elements-textPrimary">PROJECT.md Content</label>
                {!content && !fileExists && (
                  <button
              ...
              <textarea
                ...
                className={cn(
                  ...
                  'bg-veyra-elements-background-depth-3',
                  'border border-veyra-elements-borderColor',
                  'text-veyra-elements-textPrimary',
                  'placeholder-veyra-elements-textTertiary',
                  'focus:outline-none focus:ring-2 focus:ring-veyra-elements-focus',
                  'font-mono text-sm',
                  'transition-colors duration-200',
                )}
              />
                ...
                {hasUnsavedChanges && (
                  <button
                    ...
                    className={cn(
                      ...
                      'hover:text-veyra-elements-textPrimary',
                      'border border-veyra-elements-borderColor',
                      'transition-all duration-200',
                    )}
                  >
            ...
            {/* File Path Info */}
            <div className="text-xs text-veyra-elements-textTertiary">
              File location:{' '}
              <code className="px-1 py-0.5 rounded bg-veyra-elements-background-depth-2">{PROJECT_MEMORY_PATH}</code>
            </div>
          </>
        )}
        ...
        {activeSection === 'agent' && (
          <>
            ...
            <div className="flex flex-col gap-2">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <h3 className="text-lg font-medium text-veyra-elements-textPrimary">Agent Memory</h3>
                  {totalEntries > 0 ? (
                    <span className="px-2 py-0.5 text-xs rounded-full bg-green-500/10 text-green-500 font-medium">
            ...
            {totalEntries > 0 && (
              ...
              >
                <h4 className="text-sm font-medium text-veyra-elements-textPrimary mb-3 flex items-center gap-2">
                ...
                <div className="flex flex-wrap gap-3">
                  {sortedCategories.map((category) => {
                    ...
                    return (
                      ...
                      >
                        <span className="font-medium text-veyra-elements-textPrimary">{category}</span>
                        <span className="text-veyra-elements-textTertiary">
                          {count}/{20}
                        </span>
                      </div>
                    );
                  ...
                  <div
                    className={cn(
                      'flex items-center gap-2 px-3 py-1.5 rounded-md text-xs',
                      'bg-veyra-elements-item-contentAccent/10',
                      'border border-veyra-elements-item-contentAccent/20',
                    )}
                  >
                    <span className="font-medium text-veyra-elements-item-contentAccent">Total</span>
                    <span className="text-veyra-elements-item-contentAccent">{totalEntries}</span>
                  </div>
                </div>
              </div>
            )}
            ...
            {showAddForm && (
              ...
              >
                <h4 className="text-sm font-medium text-veyra-elements-textPrimary mb-3 flex items-center gap-2">
                  <div className="i-ph:plus-circle w-4 h-4 text-veyra-elements-item-contentAccent" />
                  New Memory Entry
                </h4>
                <div className="flex flex-col gap-3">
                  <div className="flex gap-3">
                    <div className="flex flex-col gap-1 flex-1">
                      <label className="text-xs text-veyra-elements-textSecondary">Category</label>
                      <input
                        type="text"
                        value={newCategory}
                    ...
                    <div className="flex flex-col gap-1 flex-1">
                      <label className="text-xs text-veyra-elements-textSecondary">Key</label>
                      <input
                        type="text"
                        value={newKey}
                  ...
                  <div className="flex flex-col gap-1">
                    <label className="text-xs text-veyra-elements-textSecondary">Value</label>
                    <textarea
                      value={newValue}
            ...
            {totalEntries > 0 ? (
                ...
                {sortedCategories.map((category) => {
                  ...
                  return (
                    <div key={category} className="flex flex-col gap-2">
                      <h4 className="text-sm font-medium text-veyra-elements-textPrimary flex items-center gap-2">
                        <div className="i-ph:folder-open w-4 h-4 text-veyra-elements-item-contentAccent" />
                        {category}
                        <span className="text-xs text-veyra-elements-textTertiary font-normal">
                          ({entries.length})
                        </span>
                      </h4>
                          ...
                          >
                            <div className="flex flex-col gap-1 min-w-0 flex-1">
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-[10px] text-veyra-elements-textTertiary whitespace-nowrap">
                                  {formatRelativeTime(entry.updatedAt)}
                                </span>
                              </div>
                              <p className="text-xs text-veyra-elements-textSecondary break-words line-clamp-2">
                                {entry.summary}
                              </p>
                            </div>
                              ...
                              {deleteTarget?.category === category && deleteTarget?.key === entry.key ? (
                                <div className="flex items-center gap-1.5">
                                  ...
                                  <button
                                    ...
                                    className={cn(
                                      'px-2 py-1 text-[10px] rounded font-medium',
                                      'text-veyra-elements-textTertiary',
                                      'hover:text-veyra-elements-textPrimary',
                                      'transition-colors duration-200',
                                    )}
                                  >
              ...
              <div
                className={cn(
                  ...
                  'bg-veyra-elements-background-depth-2',
                  'border border-veyra-elements-borderColor border-dashed',
                )}
              >
                <div className="i-ph:brain w-10 h-10 text-veyra-elements-textTertiary" />
                <div className="text-center">
                  <p className="text-sm font-medium text-veyra-elements-textPrimary mb-1">
                    No cross-session memories yet
                  </p>
                  <p className="text-xs text-veyra-elements-textTertiary max-w-sm">
            ...
            <div className="text-xs text-veyra-elements-textTertiary">
              Synced to:{' '}
              <code className="px-1 py-0.5 rounded bg-veyra-elements-background-depth-2">/home/project/MEMORY.md</code>
            </div>
          </>
        )}
      </motion.div>
