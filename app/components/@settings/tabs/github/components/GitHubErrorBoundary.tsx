...
export class GitHubErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    ...
    console.error('[Veyra:GitHubError]', {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center p-8 text-center bg-veyra-elements-background-depth-1 border border-veyra-elements-borderColor rounded-lg">
          ...
          <h3 className="text-lg font-semibold text-veyra-elements-textPrimary mb-1.5">GitHub Integration Error</h3>
