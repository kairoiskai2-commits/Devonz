...
export function GitHubCacheManager({ className = '', showStats = true }: GitHubCacheManagerProps) {
  ...
  return (
    <div
      className={cn(
        'space-y-4 p-4 bg-veyra-elements-background-depth-1 border border-veyra-elements-borderColor rounded-lg',
        className,
      )}
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-sm font-medium text-veyra-elements-textPrimary">GitHub Cache Management</h3>
        </div>
      ...
      {showStats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <div className="bg-veyra-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <div className="i-ph:hard-drive w-3 h-3 text-veyra-elements-textSecondary" />
              <span className="text-xs font-medium text-veyra-elements-textSecondary">Total Size</span>
            </div>
            <p className="text-sm font-semibold text-veyra-elements-textPrimary">
          ...
          <div className="bg-veyra-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <div className="i-ph:database w-3 h-3 text-veyra-elements-textSecondary" />
              <span className="text-xs font-medium text-veyra-elements-textSecondary">Entries</span>
            </div>
            <p className="text-sm font-semibold text-veyra-elements-textPrimary">{cacheStats.totalEntries}</p>
          </div>

          <div className="bg-veyra-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <div className="i-ph:clock w-3 h-3 text-veyra-elements-textSecondary" />
              <span className="text-xs font-medium text-veyra-elements-textSecondary">Oldest</span>
            </div>
          ...
          <div className="bg-veyra-elements-background-depth-2 p-3 rounded-lg">
            <div className="flex items-center gap-2 mb-1">
              <div className="i-ph:check-circle w-3 h-3 text-veyra-elements-textSecondary" />
              <span className="text-xs font-medium text-veyra-elements-textSecondary">Status</span>
            </div>
      ...
      {cacheEntries.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-xs font-medium text-veyra-elements-textSecondary">
          ...
          <div className="space-y-2 max-h-48 overflow-y-auto">
            {cacheEntries.map((entry) => (
              <div
                key={entry.key}
                className="flex items-center justify-between p-2 bg-veyra-elements-background-depth-2 rounded border border-veyra-elements-borderColor"
              >
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-veyra-elements-textPrimary truncate">
      ...
      <div className="flex flex-wrap gap-2 pt-2 border-t border-veyra-elements-borderColor">
        <Button
          variant="outline"
          size="sm"
