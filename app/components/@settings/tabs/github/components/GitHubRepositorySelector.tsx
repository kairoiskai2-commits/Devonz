...
export function GitHubRepositorySelector({ onClone, className }: GitHubRepositorySelectorProps) {
  ...
  if (!isConnected || !connection) {
    return (
      <div className="text-center p-8">
        <p className="text-veyra-elements-textSecondary mb-4">Please connect to GitHub first to browse repositories</p>
  ...
  if (!repositories.length) {
    return (
      <div className="text-center p-8">
        <div className="i-ph:git-branch size-12 text-veyra-elements-textTertiary mx-auto mb-4" />
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative flex-1">
          <div className="i-ph:magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 size-4 text-veyra-elements-textTertiary" />
          <input
            type="text"
        ...
        <div className="flex items-center gap-2">
          <div className="i-ph:calendar size-4 text-veyra-elements-textTertiary" />
          <select
        ...
        {/* Filter */}
        <div className="flex items-center gap-2">
          <div className="i-ph:funnel size-4 text-veyra-elements-textTertiary" />
          <select
