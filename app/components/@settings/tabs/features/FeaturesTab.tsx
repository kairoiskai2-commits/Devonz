      ...
      <div className="p-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className={cn(feature.icon, 'w-5 h-5 text-veyra-elements-textSecondary')} />
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-veyra-elements-textPrimary">{feature.title}</h4>
              {feature.beta && (
        ...
        <p className="mt-2 text-sm text-veyra-elements-textSecondary">{feature.description}</p>
        {feature.tooltip && <p className="mt-1 text-xs text-veyra-elements-textTertiary">{feature.tooltip}</p>}
      </div>
    </motion.div>
  ),
);
...
const FeatureSection = memo(
  ({
    ...
    >
      <div className="flex items-center gap-3">
        <div className={cn(icon, 'text-xl text-veyra-elements-item-contentAccent')} />
        <div>
          <h3 className="text-lg font-medium text-veyra-elements-textPrimary">{title}</h3>
          <p className="text-sm text-veyra-elements-textSecondary">{description}</p>
        </div>
      </div>
...
export default function FeaturesTab() {
  ...
  return (
    <div className="flex flex-col">
      {/* Tab Navigation */}
      <div className="flex gap-2 border-b border-veyra-elements-borderColor pb-2 mb-6">
        {featureTabSections.map((tab) => (
          <button
            ...
            style={{
              backgroundColor: activeSection === tab.id ? 'var(--veyra-elements-bg-depth-3)' : 'transparent',
              color:
                activeSection === tab.id ? 'var(--veyra-elements-textPrimary)' : 'var(--veyra-elements-textTertiary)',
          ...
          <div className="flex items-center gap-4">
            <div
              className={cn(
                ...
                'bg-veyra-elements-background-depth-3 group-hover:bg-veyra-elements-background-depth-4',
                'transition-colors duration-200',
            ...
            <div className="flex-1">
              <h4 className="text-sm font-medium text-veyra-elements-textPrimary group-hover:text-veyra-elements-item-contentAccent transition-colors">
                Prompt Library
              </h4>
              <p className="text-xs text-veyra-elements-textSecondary mt-0.5">
            ...
            <select
              ...
              className={cn(
                ...
                'bg-veyra-elements-background-depth-3 border border-veyra-elements-borderColor',
                'text-veyra-elements-textPrimary',
                'focus:outline-none focus:ring-2 focus:ring-veyra-elements-borderColorActive',
                'group-hover:border-veyra-elements-borderColorActive/30',
                'transition-all duration-200',
              )}
            >
