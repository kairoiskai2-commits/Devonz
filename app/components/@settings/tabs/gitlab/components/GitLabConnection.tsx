...
export default function GitLabConnection({ connectionTest, onTestConnection }: GitLabConnectionProps) {
  ...
  return (
    <motion.div
      className="bg-veyra-elements-background border border-veyra-elements-borderColor rounded-lg"
      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-medium text-veyra-elements-textPrimary">GitLab Connection</h3>
          </div>
        </div>

        {!isConnected && (
          <div className="text-xs text-veyra-elements-textSecondary bg-veyra-elements-background-depth-1 p-3 rounded-lg mb-4">
            <p className="flex items-center gap-1 mb-1">
              <span className="i-ph:lightbulb w-3.5 h-3.5 text-veyra-elements-icon-success" />
              <span className="font-medium">Tip:</span> You can also set the{' '}
              <code className="px-1 py-0.5 bg-veyra-elements-background-depth-2 rounded">
        ...
        <form onSubmit={handleConnect}>
          <div className="grid grid-cols-1 gap-4">
            <div>
              <label className="block text-sm text-veyra-elements-textSecondary mb-2">GitLab URL</label>
              <input
                type="text"
                inputMode="url"
                autoComplete="url"
