  ...
  return (
    <Card
      ...
      style={{
        ...
        borderColor: provider.settings.enabled ? 'rgba(139, 92, 246, 0.3)' : 'var(--veyra-elements-borderColor)',
      }}
    >
                ...
                <div className="space-y-2">
                  ...
                  {isEditing ? (
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-lg text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-veyra-elements-borderColorActive transition-all duration-200 shadow-sm"
                      style={{
                    ...
                    >
                      <div className="flex items-center gap-3 text-gray-400 group-hover:text-white">
                        <div className="i-ph:link w-4 h-4 group-hover:text-veyra-elements-item-contentAccent transition-colors" />
