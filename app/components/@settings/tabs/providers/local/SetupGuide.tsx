    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button
          ...
          size="sm"
          onClick={onBack}
          className="bg-transparent hover:bg-transparent text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary transition-all duration-200 p-2"
          aria-label="Back to Dashboard"
        >
          <div className="i-ph:arrow-left w-4 h-4" />
        </Button>
        <div>
          <h2 className="text-xl font-semibold text-veyra-elements-textPrimary">Local Provider Setup Guide</h2>
      ...
      <Card className="bg-gradient-to-r from-[#06B6D4]/10 to-[#06B6D4]/5 border border-veyra-elements-borderColorActive/20 shadow-sm">
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-veyra-elements-textPrimary">System Requirements</h3>
              <p className="text-sm text-veyra-elements-textSecondary">Recommended hardware for optimal performance</p>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-veyra-elements-textPrimary">CPU</span>
              </div>
              <p className="text-veyra-elements-textSecondary">8+ cores, modern architecture</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="i-ph:database w-4 h-4 text-blue-500" />
                <span className="font-medium text-veyra-elements-textPrimary">RAM</span>
              </div>
              <p className="text-veyra-elements-textSecondary">16GB minimum, 32GB+ recommended</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <div className="i-ph:monitor w-4 h-4 text-veyra-elements-item-contentAccent" />
                <span className="font-medium text-veyra-elements-textPrimary">GPU</span>
              </div>
              <p className="text-veyra-elements-textSecondary">NVIDIA RTX 30xx+ or AMD RX 6000+</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-veyra-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#06B6D4]/20 to-[#06B6D4]/20 flex items-center justify-center ring-1 ring-veyra-elements-borderColorActive/30">
              <div className="i-ph:hard-drive w-6 h-6 text-veyra-elements-item-contentAccent" />
            </div>
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-veyra-elements-textPrimary">Ollama Setup</h3>
              <p className="text-sm text-veyra-elements-textSecondary">
                Most popular choice for running open-source models locally with desktop app
              </p>
            </div>
            <span className="px-3 py-1 bg-veyra-elements-item-backgroundAccent text-veyra-elements-item-contentAccent text-xs font-medium rounded-full">
              Recommended
            </span>
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-veyra-elements-textPrimary flex items-center gap-2">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
              ...
              <p className="text-sm text-veyra-elements-textSecondary mb-3">
                New user-friendly desktop application with built-in model management and web interface.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="i-ph:monitor w-4 h-4 text-veyra-elements-textPrimary" />
                    <strong className="text-veyra-elements-textPrimary">macOS</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full bg-gradient-to-r from-[#06B6D4]/10 to-[#06B6D4]/10 hover:from-[#06B6D4]/20 hover:to-[#06B6D4]/20 border-veyra-elements-borderColorActive/30 hover:border-veyra-elements-borderColorActive transition-all duration-300 gap-2 group shadow-sm hover:shadow-lg hover:shadow-[#06B6D4]/20 font-medium"
                    _asChild
                  >
                    <a
                ...
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="i-ph:monitor w-4 h-4 text-veyra-elements-textPrimary" />
                    <strong className="text-veyra-elements-textPrimary">Windows</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="mt-3 p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <p className="text-xs text-veyra-elements-textSecondary">
                  Desktop app includes a web interface at{' '}
                  <code className="bg-veyra-elements-background-depth-4 px-1 rounded">http://localhost:11434</code>
                </p>
              </div>
            </div>

            {/* CLI Installation */}
            <div className="p-4 rounded-lg bg-veyra-elements-background-depth-3">
              <div className="flex items-center gap-2 mb-3">
                <div className="i-ph:terminal w-5 h-5 text-veyra-elements-textPrimary" />
                <h5 className="font-medium text-veyra-elements-textPrimary">Command Line (Advanced)</h5>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="i-ph:monitor w-4 h-4 text-veyra-elements-textPrimary" />
                    <strong className="text-veyra-elements-textPrimary">Windows</strong>
                  </div>
                  <div className="text-xs bg-veyra-elements-background-depth-4 p-2 rounded font-mono text-veyra-elements-textPrimary">
                ...
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <div className="i-ph:terminal w-4 h-4 text-veyra-elements-textPrimary" />
                    <strong className="text-veyra-elements-textPrimary">Linux</strong>
                  </div>
                  <div className="text-xs bg-veyra-elements-background-depth-4 p-2 rounded font-mono text-veyra-elements-textPrimary">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-veyra-elements-background-depth-3">
                <h5 className="font-medium text-veyra-elements-textPrimary mb-3 flex items-center gap-2">
                  <div className="i-ph:code w-4 h-4 text-green-500" />
                  Code & Development
                </h5>
                <div className="space-y-2 text-xs bg-veyra-elements-background-depth-4 p-3 rounded font-mono text-veyra-elements-textPrimary">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-[#06B6D4]/5 border border-veyra-elements-borderColorActive/20">
                <div className="flex items-center gap-2 mb-2">
                  <div className="i-ph:activity w-4 h-4 text-veyra-elements-item-contentAccent" />
                  <span className="font-medium text-veyra-elements-item-contentAccent">Performance Optimized</span>
                </div>
                <ul className="text-xs text-veyra-elements-textSecondary space-y-1">
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-veyra-elements-textSecondary space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <div className="text-xs bg-veyra-elements-background-depth-4 p-3 rounded font-mono text-veyra-elements-textPrimary space-y-1">
      ...
      <Card className="bg-veyra-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-veyra-elements-textPrimary">LM Studio Setup</h3>
              <p className="text-sm text-veyra-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-veyra-elements-background-depth-3">
                <h5 className="font-medium text-veyra-elements-textPrimary mb-2">Start Local Server</h5>
                <ol className="text-xs text-veyra-elements-textSecondary space-y-1 list-decimal list-inside">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-veyra-elements-textSecondary">
                    To work with Veyra DIY, you MUST enable CORS in LM Studio:
                  </p>
                  <ol className="text-xs text-veyra-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
                    <li>In Server Settings, check "Enable CORS"</li>
                    <li>Set Network Interface to "0.0.0.0" for external access</li>
                    <li>
                      Alternatively, use CLI:{' '}
                      <code className="bg-veyra-elements-background-depth-4 px-1 rounded">
          ...
          <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
            ...
            <ul className="text-xs text-veyra-elements-textSecondary space-y-1 list-disc list-inside">
      ...
      <Card className="bg-veyra-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-veyra-elements-textPrimary">LocalAI Setup</h3>
              <p className="text-sm text-veyra-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-veyra-elements-background-depth-3">
                <h5 className="font-medium text-veyra-elements-textPrimary mb-2">Quick Install</h5>
                <div className="text-xs bg-veyra-elements-background-depth-4 p-3 rounded font-mono text-veyra-elements-textPrimary space-y-1">
              ...
              <div className="p-4 rounded-lg bg-veyra-elements-background-depth-3">
                <h5 className="font-medium text-veyra-elements-textPrimary mb-2">Docker (Recommended)</h5>
                <div className="text-xs bg-veyra-elements-background-depth-4 p-3 rounded font-mono text-veyra-elements-textPrimary space-y-1">
      ...
      <Card className="bg-gradient-to-r from-[#06B6D4]/10 to-[#06B6D4]/5 border border-veyra-elements-borderColorActive/20 shadow-sm">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-lg bg-[#06B6D4]/20 flex items-center justify-center">
              <div className="i-ph:activity w-5 h-5 text-veyra-elements-item-contentAccent" />
            </div>
            <div>
              <h3 className="text-lg font-semibold text-veyra-elements-textPrimary">Performance Optimization</h3>
              <p className="text-sm text-veyra-elements-textSecondary">Tips to improve local AI performance</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="font-medium text-veyra-elements-textPrimary">Hardware Optimizations</h4>
              <ul className="text-sm text-veyra-elements-textSecondary space-y-2">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-veyra-elements-textPrimary">Software Optimizations</h4>
              <ul className="text-sm text-veyra-elements-textSecondary space-y-2">
                <li className="flex items-start gap-2">
      ...
      <Card className="bg-veyra-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-veyra-elements-textPrimary">Alternative Options</h3>
              <p className="text-sm text-veyra-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-medium text-veyra-elements-textPrimary">Other Local Solutions</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <div className="i-ph:package w-4 h-4 text-blue-500" />
                    <span className="font-medium text-veyra-elements-textPrimary">Jan.ai</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-veyra-elements-textPrimary">Oobabooga</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <div className="i-ph:plugs-connected w-4 h-4 text-veyra-elements-item-contentAccent" />
                    <span className="font-medium text-veyra-elements-textPrimary">KoboldAI</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">
            ...
            <div className="space-y-4">
              <h4 className="font-medium text-veyra-elements-textPrimary">Cloud Alternatives</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <div className="i-ph:globe w-4 h-4 text-orange-500" />
                    <span className="font-medium text-veyra-elements-textPrimary">OpenRouter</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-veyra-elements-textPrimary">Together AI</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">Fast inference with open-source models</p>
                </div>
                <div className="p-3 rounded-lg bg-veyra-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <div className="i-ph:activity w-4 h-4 text-pink-500" />
                    <span className="font-medium text-veyra-elements-textPrimary">Groq</span>
                  </div>
                  <p className="text-xs text-veyra-elements-textSecondary">
