    ...
    return (
      <div className={cn('flex flex-col items-center justify-center py-12 gap-3')}>
        <div
          ...
          style={{ fontSize: '2rem' }}
        />
        <p className="text-sm text-veyra-elements-textSecondary">Loading provider status…</p>
      </div>
    );
  }
      ...
      >
        <div className="flex items-center justify-between gap-4 mt-8 mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h4 className="text-md font-medium text-veyra-elements-textPrimary">Cloud Providers</h4>
          ...
          <div className="flex items-center gap-2">
            <span className="text-sm text-veyra-elements-textSecondary">Enable All Cloud</span>
