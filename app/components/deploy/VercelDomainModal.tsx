          ...
          <RadixDialog.Portal>
            ...
            <RadixDialog.Content asChild>
              <motion.div
                ...
                style={{
                  backgroundColor: 'var(--veyra-elements-bg-depth-3)',
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <RadixDialog.Title
                        ...
                        style={{ color: 'var(--veyra-elements-textPrimary)' }}
                      >
                        Domain Settings
                      </RadixDialog.Title>
                      <RadixDialog.Description
                        className="text-sm"
                        style={{ color: 'var(--veyra-elements-textSecondary)' }}
                      >
                  ...
                  <RadixDialog.Close asChild>
                    <IconButton
                      ...
                      className="text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary"
                    />
                  </RadixDialog.Close>
                </div>
                ...
                <div className="p-6 space-y-6">
                  <div>
                    <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--veyra-elements-textPrimary)' }}>
                    ...
                    <div className="flex items-center gap-2">
                      <div
                        ...
                        style={{
                          backgroundColor: 'var(--veyra-elements-bg-depth-2)',
                          border: '1px solid var(--veyra-elements-borderColor)',
                        }}
                      >
                        <input
                        ...
                        <span
                          ...
                          style={{
                            ...
                            backgroundColor: 'var(--veyra-elements-bg-depth-1)',
                          }}
                        >
                          .vercel.app
                        </span>
                        ...
                        style={{
                          backgroundColor:
                            isSaving || !newSubdomain.trim()
                              ? 'var(--veyra-elements-bg-depth-3)'
                              : 'var(--veyra-elements-bg-depth-4)',
                          color:
                            isSaving || !newSubdomain.trim()
                              ? 'var(--veyra-elements-textTertiary)'
                              : 'var(--veyra-elements-textPrimary)',
                          border: '1px solid var(--veyra-elements-borderColor)',
                    ...
                    <p className="mt-2 text-xs" style={{ color: 'var(--veyra-elements-textTertiary)' }}>
                  ...
                  {error && (
                    <div
                      ...
                      style={{
                        backgroundColor: 'var(--veyra-elements-button-danger-background)',
                        border: '1px solid var(--veyra-elements-button-danger-backgroundHover)',
                      }}
                    >
                      <div className="i-ph:warning-circle text-red-400 w-5 h-5 flex-shrink-0" />
                      <span style={{ color: 'var(--veyra-elements-button-danger-text)' }}>{error}</span>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    {isLoading ? (
                      <div
                        ...
                        style={{ backgroundColor: 'var(--veyra-elements-bg-depth-2)' }}
                      >
                        <div
                        ...
                        {domains.map((domain) => (
                          ...
                          >
                            <div className="flex items-center gap-3">
                              ...
                              />
                              <span className="text-sm" style={{ color: 'var(--veyra-elements-textPrimary)' }}>
                                {domain.name}
                              </span>
                              {domain.verified && (
                                <span
                            ...
                            <div className="flex items-center gap-2">
                              <a
                                ...
                                className="p-2 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity hover:bg-veyra-elements-bg-depth-3"
                                style={{ color: 'var(--veyra-elements-textSecondary)' }}
                              >
                              ...
                              <button
                                ...
                                style={{ color: 'var(--veyra-elements-button-danger-text)' }}
                              >
                  ...
                  {currentUrl && (
                    <div className="pt-4" style={{ borderTop: '1px solid var(--veyra-elements-borderColor)' }}>
                      <h3 className="text-sm font-medium mb-2" style={{ color: 'var(--veyra-elements-textPrimary)' }}>
                        Current Deployment
                      </h3>
                      <a
                        href={currentUrl}
                        ...
                        style={{ color: 'var(--veyra-elements-messages-linkColor)' }}
                      >
