...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-veyra-elements-textSecondary border-b border-veyra-elements-borderColor">
    ...
    <>
      <motion.div
        ...
        className={cn(
          ...
          'bg-veyra-elements-background-depth-1 border-r border-veyra-elements-borderColor',
          'shadow-xl backdrop-blur-sm text-sm',
          isSettingsOpen ? 'z-40' : 'z-sidebar',
        )}
      >
        <PanelErrorBoundary panelName="sidebar">
          <div className="h-12 flex items-center justify-between px-4 border-b border-veyra-elements-borderColor bg-veyra-elements-background-depth-2/80 rounded-tr-2xl">
            <span className="text-veyra-elements-textPrimary font-semibold text-lg">Veyra</span>
          ...
          <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
            <div className="p-4 space-y-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    selectionMode
                      ...
                      : 'bg-veyra-elements-background-depth-3 text-veyra-elements-textSecondary hover:bg-veyra-elements-background-depth-4 border border-veyra-elements-borderColor',
                  )}
              ...
              <div className="relative w-full">
                ...
                <input
                  className="w-full bg-veyra-elements-background-depth-3 relative pl-9 pr-3 py-2.5 rounded-lg focus:outline-none focus:ring-1 focus:ring-accent-500/50 text-sm text-veyra-elements-textPrimary placeholder-veyra-elements-textTertiary border border-veyra-elements-borderColor"
                  type="search"
            ...
            <div className="flex items-center justify-between text-sm px-4 py-2">
              <div className="font-medium text-veyra-elements-textSecondary">Your Chats</div>
              {selectionMode && (
                <div className="flex items-center gap-2">
            ...
            <div className="flex-1 overflow-auto px-3 pb-3 modern-scrollbar">
              {filteredList.length === 0 && (
                <div className="px-4 text-veyra-elements-textTertiary text-sm">
              ...
              <DialogRoot open={dialogContent !== null}>
                {binDates(filteredList).map(({ category, items }) => (
                  <div key={category} className="mt-2 first:mt-0 space-y-1">
                    <div className="text-xs font-medium text-veyra-elements-textTertiary sticky top-0 z-1 bg-veyra-elements-background-depth-1 px-4 py-1">
                      {category}
                    </div>
                ...
                <Dialog onBackdrop={closeDialog} onClose={closeDialog}>
                  {dialogContent?.type === 'delete' && (
                    <>
                      <div className="p-6 bg-veyra-elements-bg-depth-1">
                        <DialogTitle className="text-veyra-elements-textPrimary">Delete Chat?</DialogTitle>
                        <DialogDescription className="mt-2 text-veyra-elements-textSecondary">
                          <p>
                            You are about to delete{' '}
                            <span className="font-medium text-veyra-elements-textPrimary">
                      ...
                      <div className="flex justify-end gap-3 px-6 py-4 bg-veyra-elements-bg-depth-2 border-t border-veyra-elements-borderColor">
                  ...
                  {dialogContent?.type === 'bulkDelete' && (
                    <>
                      <div className="p-6 bg-veyra-elements-bg-depth-1">
                        <DialogTitle className="text-veyra-elements-textPrimary">Delete Selected Chats?</DialogTitle>
                        <DialogDescription className="mt-2 text-veyra-elements-textSecondary">
                          <p>
                            You are about to delete {dialogContent.items.length}{' '}
                            {dialogContent.items.length === 1 ? 'chat' : 'chats'}:
                          </p>
                          <div className="mt-2 max-h-32 overflow-auto border border-veyra-elements-borderColor rounded-md bg-veyra-elements-bg-depth-2 p-2">
