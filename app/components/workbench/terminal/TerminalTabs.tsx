    ...
    >
      <div className="h-full">
        <div className="h-full flex flex-col" style={{ background: 'var(--veyra-elements-bg-depth-1)' }}>
          <div
            className="flex items-center border-y border-veyra-elements-borderColor gap-1.5 min-h-[34px] p-2"
                  ...
                  {index === 0 ? (
                    <button
                      ...
                      className={cn(
                        ...
                        {
                          'bg-veyra-elements-terminals-buttonBackground hover:text-veyra-elements-textPrimary':
                            isActive,
                          'bg-veyra-elements-background-depth-2 text-veyra-elements-textSecondary hover:bg-veyra-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={cn(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-veyra-elements-terminals-buttonBackground': isActive,
                            'bg-veyra-elements-background-depth-2 text-veyra-elements-textSecondary hover:bg-veyra-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-veyra-elements-textTertiary hover:text-veyra-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachVeyraTerminal(terminal);
                  } else {
            ...
            <button
              ...
              className={cn(
                ...
                isRestarting
                  ...
                  : 'hover:bg-veyra-elements-terminals-buttonBackground cursor-pointer',
              )}
              style={{ color: '#22D3EE' }}
            >
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting veyra terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachVeyraTerminal(terminal)}
