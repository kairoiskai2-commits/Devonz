...
function getChangeTypeColor(type: StagedChange['type']): string {
  switch (type) {
    ...
    default:
      return 'bg-gray-500/20 text-veyra-elements-textTertiary border-gray-500/30';
  }
}
...
const DiffLineRow = memo(({ line }: DiffLineRowProps) => {
  ...
  return (
    <div className={cn('flex text-sm font-mono', bgColor)}>
      {/* Line numbers */}
      <div
        className="w-12 flex-shrink-0 text-right pr-2 select-none border-r border-veyra-elements-borderColor"
        style={{
          backgroundColor: 'var(--veyra-elements-background-depth-4)',
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      >
        ...
        <span className="text-sm" style={{ color: 'var(--veyra-elements-textSecondary)' }}>
              ...
              >
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex flex-col">
                        <span className="text-sm font-medium" style={{ color: 'var(--veyra-elements-textPrimary)' }}>
                          {fileName}
                        </span>
                        <span className="text-xs" style={{ color: 'var(--veyra-elements-textSecondary)' }}>
                          {change.filePath}
                        </span>
                      </div>
                      ...
                      {position.total > 1 && (
                        <>
                          ...
                          <div
                            ...
                            style={{ backgroundColor: 'var(--veyra-elements-borderColor)' }}
                          />
                        </>
                      )}
                      <IconButton
                        ...
                        onClick={handleClose}
                        title="Close (Escape)"
                        className="text-veyra-elements-textSecondary"
                      />
                    </div>
                  </div>
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: 'var(--veyra-elements-background-depth-4)',
                      borderTop: '1px solid var(--veyra-elements-borderColor)',
                    }}
                  >
                    {/* Keyboard hints */}
                    <div
