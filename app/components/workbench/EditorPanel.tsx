        ...
        <Panel defaultSize={showTerminal ? DEFAULT_EDITOR_SIZE : 100} minSize={20}>
          <PanelGroup direction="horizontal">
            <Panel
              ...
              minSize={15}
              collapsible
              className="border-r border-veyra-elements-borderColor"
              style={{ background: 'var(--veyra-elements-bg-depth-1)' }}
            >
              <div className="h-full">
                <Tabs.Root defaultValue="files" className="flex flex-col h-full">
                  <PanelHeader className="w-full text-sm font-medium text-veyra-elements-textSecondary px-1">
                    <div className="h-full flex-shrink-0 flex items-center justify-between w-full">
                      <Tabs.List className="h-full flex-shrink-0 flex items-center gap-1">
                        <Tabs.Trigger
                          ...
                          aria-label="Files"
                          className={cn(
                            'h-full bg-transparent hover:bg-veyra-elements-background-depth-3 p-1.5 rounded-lg text-veyra-elements-textTertiary hover:text-veyra-elements-textPrimary data-[state=active]:text-veyra-elements-textPrimary',
                          )}
                        >
