...
const GripIcon = () => (
  ...
  >
    <div
      style={{
        color: 'var(--veyra-elements-textSecondary, rgba(0,0,0,0.5))',
        fontSize: '10px',
        lineHeight: '5px',
        userSelect: 'none',
        marginLeft: '1px',
...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('veyra:refresh-preview', handler);

    return () => window.removeEventListener('veyra:refresh-preview', handler);
  }, [reloadPreview]);
    ...
    return (
      <div
        ...
        style={{
          ...
          height: '100%',
          cursor: 'ew-resize',
          background: 'var(--veyra-elements-background-depth-4, rgba(0,0,0,.3))',
          display: 'flex',
          alignItems: 'center',
          justifyContent: 'center',
        ...
        onMouseOver={(e) =>
          (e.currentTarget.style.background = 'var(--veyra-elements-background-depth-4, rgba(0,0,0,.3))')
        }
        onMouseOut={(e) =>
          (e.currentTarget.style.background = 'var(--veyra-elements-background-depth-3, rgba(0,0,0,.15))')
        }
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-veyra-elements-background-depth-2 p-2 flex items-center gap-2">
        <div className="flex items-center gap-2">
          <IconButton icon="i-ph:arrow-clockwise" aria-label="Reload preview" onClick={reloadPreview} />
        </div>

        <div className="flex-grow flex items-center gap-1 bg-veyra-elements-preview-addressBar-background border border-veyra-elements-borderColor text-veyra-elements-preview-addressBar-text rounded-full px-3 py-1 text-sm hover:bg-veyra-elements-preview-addressBar-backgroundHover hover:focus-within:bg-veyra-elements-preview-addressBar-backgroundActive focus-within:bg-veyra-elements-preview-addressBar-backgroundActive focus-within-border-veyra-elements-borderColorActive focus-within:text-veyra-elements-preview-addressBar-textActive">
          ...
          {activePreview && (
            <button
              ...
              className="flex-shrink-0 p-1 bg-transparent text-veyra-elements-preview-addressBar-text hover:text-veyra-elements-preview-addressBar-textActive rounded transition-colors"
        ...
        <div className="flex items-center gap-2">
          ...
          <IconButton
            ...
            className={
              inspector.mode !== 'off'
                ? 'bg-veyra-elements-background-depth-3 !text-veyra-elements-item-contentAccent'
                : ''
            }
          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                />
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-veyra-elements-bg-depth-1 rounded-xl shadow-2xl border border-veyra-elements-borderColor overflow-hidden">
                  <div className="p-3 border-b border-veyra-elements-borderColor">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-sm font-medium text-veyra-elements-textPrimary">Window Options</span>
                    </div>
                    <div className="flex flex-col gap-2">
                      <button
                        className={`flex w-full justify-between items-center text-start bg-transparent text-xs text-veyra-elements-textTertiary hover:text-veyra-elements-textPrimary`}
                        onClick={() => {
                          openInNewTab();
                        }}
                      >
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-veyra-elements-textTertiary">Show Device Frame</span>
                        <button
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-veyra-elements-textTertiary">Landscape Mode</span>
                        <button
                          className={`w-10 h-5 rounded-full transition-colors duration-200 ${
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-veyra-elements-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-veyra-elements-bg-depth-3 bg-veyra-elements-bg-depth-1"
                      onClick={() => {
                    ...
                    >
                      <div
                        className={`${size.icon} w-5 h-5 text-veyra-elements-textTertiary group-hover:text-purple-700 dark:group-hover:text-purple-700 transition-colors duration-200`}
                      />
                      <div className="flex-grow flex flex-col">
                        ...
                        <span className="text-xs text-veyra-elements-textTertiary group-hover:text-purple-700 dark:group-hover:text-purple-700 transition-colors duration-200">
      ...
      <div className="flex-1 border-t border-veyra-elements-borderColor flex justify-center items-center overflow-auto">
        <div
          style={{
            width: isDeviceModeOn ? (showDeviceFrameInPreview ? '100%' : `${widthPercent}%`) : '100%',
            height: '100%',
            overflow: 'auto',
            background: 'var(--veyra-elements-background-depth-1)',
            position: 'relative',
            display: 'flex',
            justifyContent: 'center',
            alignItems: 'center',
        ...
        >
          {activePreview ? (
            <>
              {isDeviceModeOn && showDeviceFrameInPreview ? (
                ...
                <iframe
                  ref={iframeRef}
                  title="preview"
                  className="border-none w-full h-full bg-veyra-elements-background-depth-1"
                  src={iframeUrl ?? 'about:blank'}
                  sandbox="allow-scripts allow-forms allow-popups allow-modals allow-storage-access-by-user-activation allow-same-origin"
            ...
            <div className="flex w-full h-full justify-center items-center bg-veyra-elements-background-depth-1 text-veyra-elements-textPrimary">
            ...
            <>
              ...
              <div
                style={{
                  ...
                  background: 'var(--veyra-elements-background-depth-3, rgba(0,0,0,0.7))',
                  color: 'var(--veyra-elements-textPrimary, white)',
                  padding: '2px 8px',
                  borderRadius: '4px',
                  fontSize: '12px',
                  pointerEvents: 'none',
