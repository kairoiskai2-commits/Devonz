      ...
      <motion.div
        ...
        style={{
          background: isCheckedOut
            ? 'var(--veyra-elements-button-primary-background)'
            : isHovered
              ? 'var(--veyra-elements-bg-depth-4)'
              : 'transparent',
          opacity: isCheckedOut ? 0.95 : 1,
          borderBottom: '1px solid var(--veyra-elements-borderColor)',
          borderLeft: isHovered
            ? '2px solid var(--veyra-elements-button-primary-background)'
      ...
      >
        ...
        >
          ...
          <div className="flex-shrink-0 self-stretch" style={{ width: '140px', minHeight: '80px' }}>
            {thumbnail ? (
              <img
                ...
                style={{
                  border: '1px solid var(--veyra-elements-borderColor)',
                  background: 'var(--veyra-elements-bg-depth-3)',
                }}
                onClick={(e) => {
                  e.stopPropagation();
              ...
              >
                <div className="i-ph:image text-base" style={{ color: 'var(--veyra-elements-textTertiary)' }} />
              </div>
            )}
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2 mb-1">
              <span
                ...
                style={{
                  ...
                  color: 'var(--veyra-elements-textSecondary)',
                }}
              >
                {commit.shortSha}
              </span>
              ...
              {isLatest && (
                <span
                  ...
                  style={{
                    ...
                    color: 'var(--veyra-elements-button-primary-text)',
                  }}
                >
                  Latest
                </span>
              ...
              {isCheckedOut && !isLatest && (
                <span
                  className="px-2 py-0.5 rounded text-xs font-medium"
                  style={{
                    background: 'var(--veyra-elements-item-backgroundAccent)',
                    color: 'var(--veyra-elements-item-contentAccent)',
                  }}
                >
                  Active
                </span>
            ...
            <h3 className="text-sm font-medium text-veyra-elements-textPrimary truncate mb-0.5">{commit.message}</h3>

            <div className="flex items-center gap-1 text-xs text-veyra-elements-textTertiary">
              ...
              <motion.div
                ...
                style={{ color: 'var(--veyra-elements-textTertiary)' }}
          ...
          {isExpanded && (
            ...
            >
              <div
                ...
                style={{ borderTop: '1px solid var(--veyra-elements-borderColor)' }}
              >
                {chatSummary && (
                  <div className="mb-2">
                    <div className="font-medium text-veyra-elements-textSecondary mb-1">Summary</div>
                    <div className="text-veyra-elements-textTertiary prose-sm max-w-none">
                ...
                {totalTokens != null && totalTokens > 0 && (
                  <div className="flex items-center gap-2">
                    <span className="font-medium text-veyra-elements-textSecondary">Tokens:</span>
                    <span className="font-mono text-veyra-elements-textTertiary">{totalTokens.toLocaleString()}</span>
                  </div>
                )}
                {!chatSummary && (totalTokens == null || totalTokens === 0) && (
                  <div className="text-veyra-elements-textTertiary italic">No additional details available.</div>
                )}
              </div>
            </motion.div>
          )}
...
export const Versions = memo(() => {
  ...
  return (
    <div className="h-full flex flex-col" style={{ background: 'var(--veyra-elements-bg-depth-1)' }}>
      {/* Header */}
      <div className="p-4 border-b border-veyra-elements-borderColor">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <div className="i-ph:git-branch text-lg text-veyra-elements-textSecondary" />
            <h2 className="text-lg font-semibold text-veyra-elements-textPrimary">Git History</h2>
          </div>
          <div className="flex items-center gap-2">
            {checkedOutSha && (
              <button
            ...
            <span className="text-sm text-veyra-elements-textTertiary">{commits.length} commits</span>
          </div>
        </div>

        <p className="text-xs text-veyra-elements-textTertiary mb-3">
          Every AI response is automatically committed. Restore any previous version with one click.
        </p>

        {/* Search */}
        <div className="relative">
          <div className="i-ph:magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-veyra-elements-textTertiary" />
          <input
            type="text"
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            placeholder="Search commits..."
            className="w-full pl-9 pr-4 py-2 rounded-lg text-sm text-veyra-elements-textPrimary placeholder-veyra-elements-textTertiary outline-none"
            style={{
              background: 'var(--veyra-elements-button-secondary-background)',
              border: '1px solid var(--veyra-elements-borderColor)',
            }}
      ...
      <div className="flex-1 overflow-y-auto p-2">
        {loading ? (
          <div className="flex flex-col items-center justify-center h-full">
            <div className="i-ph:spinner-gap-bold animate-spin text-2xl text-veyra-elements-textTertiary mb-2" />
            <span className="text-sm text-veyra-elements-textTertiary">Loading history...</span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            <div className="i-ph:git-commit text-4xl text-veyra-elements-textTertiary mb-4" />
            <h3 className="text-sm font-medium text-veyra-elements-textSecondary mb-1">No commits yet</h3>
            <p className="text-xs text-veyra-elements-textTertiary max-w-xs">
              Commits are created automatically after each AI response. Start a conversation to see history here.
            </p>
          </div>
        ) : (
          <div className="flex flex-col items-center justify-center h-full text-center p-8">
            <div className="i-ph:magnifying-glass text-4xl text-veyra-elements-textTertiary mb-4" />
            <h3 className="text-sm font-medium text-veyra-elements-textSecondary mb-1">No matches</h3>
            <p className="text-xs text-veyra-elements-textTertiary">No commits match &quot;{searchQuery}&quot;</p>
          </div>
        )}
      </div>
          ...
          >
            <motion.img
              ...
              style={{
                ...
                maxHeight: '90vh',
                objectFit: 'contain',
                border: '2px solid var(--veyra-elements-borderColor)',
              }}
          ...
          >
            <motion.div
              ...
              style={{
                ...
                maxWidth: '1000px',
                maxHeight: '85vh',
                background: 'var(--veyra-elements-bg-depth-2)',
                border: '2px solid var(--veyra-elements-borderColor)',
              }}
              onClick={(e) => e.stopPropagation()}
            >
              <div
                ...
                style={{ borderBottom: '1px solid var(--veyra-elements-borderColor)' }}
              >
                <span className="text-sm font-medium text-veyra-elements-textPrimary">Full Diff</span>
                <button
                  onClick={() => setDiffModalContent(null)}
              ...
              <div className="flex-1 overflow-auto p-4">
                <pre
                  ...
                  style={{
                    background: 'var(--veyra-elements-bg-depth-1)',
                    border: '1px solid var(--veyra-elements-borderColor)',
                  }}
                >
                  {diffModalContent.split('\n').map((line, i) => {
                    let color = 'var(--veyra-elements-textTertiary)';
                    let bg = 'transparent';
            ...
            >
              ...
              <div className="flex-1 overflow-auto">
                {filesModal.files.map(({ file, status }) => {
                  ...
                  return (
                    <div key={file} style={{ borderBottom: '1px solid var(--veyra-elements-borderColor)' }}>
                      <button
                        type="button"
                        className="flex items-center gap-2 px-4 py-2 w-full text-left cursor-pointer transition-colors hover:brightness-110"
                        style={{ background: 'var(--veyra-elements-bg-depth-3)' }}
                        onClick={() => {
                      ...
                      >
                        <div
                          className={`i-ph:caret-right text-xs transition-transform text-veyra-elements-textSecondary ${isExpanded ? 'rotate-90' : ''}`}
                        />
                        <span
                        ...
                        <div className="i-ph:file-text text-xs text-veyra-elements-textSecondary" />
                        <span className="font-mono text-sm text-veyra-elements-textPrimary flex-1">{file}</span>
