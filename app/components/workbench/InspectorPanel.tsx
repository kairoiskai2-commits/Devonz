...
export const InspectorPanel = memo(({ inspector }: InspectorPanelProps) => {
  ...
  if (!selectedElement) {
    return (
      <div className="flex flex-col h-full w-full bg-veyra-elements-background-depth-2 items-center justify-center p-6 text-center">
        <div className="i-ph:cursor-click text-4xl text-veyra-elements-textSecondary mb-3" />
        <h3 className="text-sm font-medium text-veyra-elements-textPrimary mb-1">No Element Selected</h3>
        <p className="text-xs text-veyra-elements-textSecondary max-w-[200px]">
  ...
  return (
    <div
      className="flex flex-col h-full w-full bg-veyra-elements-background-depth-2 overflow-hidden"
      role="region"
      aria-label="Element Inspector"
    >
      {/* Header */}
      <div className="flex items-center justify-between p-3 border-b border-veyra-elements-borderColor bg-veyra-elements-background-depth-3">
        <div className="flex items-center gap-2">
          <div className="i-ph:cursor-click text-accent-400" aria-hidden="true" />
          <h3 className="font-medium text-veyra-elements-textPrimary text-sm">Inspector</h3>
        </div>
        <button
          onClick={inspector.closePanel}
          className="text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary transition-colors p-1 rounded hover:bg-veyra-elements-background-depth-4"
      ...
      <section
        ...
        className="p-3 border-b border-veyra-elements-borderColor bg-veyra-elements-background-depth-2"
      >
        <div className="font-mono text-xs bg-veyra-elements-background-depth-3 px-2 py-1.5 rounded border border-veyra-elements-borderColor flex items-center gap-1 flex-wrap">
          ...
          {selectedElement.rect && (
            <span className="text-veyra-elements-textSecondary ml-auto">
        ...
        {selectedElement.isImage && selectedElement.imageSrc && (
          <div className="mt-2 flex items-center gap-2 p-2 rounded border border-veyra-elements-borderColor bg-veyra-elements-background-depth-3">
            <div className="i-ph:image text-purple-400 w-4 h-4 shrink-0" aria-hidden="true" />
            <div className="flex-1 min-w-0 text-xs">
              <p className="text-veyra-elements-textPrimary truncate" title={selectedElement.imageSrc}>
              ...
              {selectedElement.imageNaturalWidth != null && selectedElement.imageNaturalHeight != null && (
                <p className="text-veyra-elements-textSecondary">
                  {selectedElement.imageNaturalWidth} &times; {selectedElement.imageNaturalHeight} native
                </p>
              )}
              {selectedElement.imageAlt && (
                <p className="text-veyra-elements-textSecondary truncate" title={selectedElement.imageAlt}>
      ...
      {/* Bulk style selector */}
      <div className="p-3 border-b border-veyra-elements-borderColor bg-veyra-elements-background-depth-2">
        <BulkStyleSelector
      ...
      {/* Tabs */}
      <div
        className="flex border-b border-veyra-elements-borderColor"
      ...
      >
        {TABS.map((tab) => (
          <button
            ...
            style={{
              background: activeTab === tab ? 'var(--veyra-elements-bg-depth-2)' : 'transparent',
              color: activeTab === tab ? 'var(--color-accent-500, #3b82f6)' : 'var(--veyra-elements-textSecondary)',
      ...
      {/* Tab content */}
      <div
        className="overflow-y-auto flex-1 min-h-0 bg-veyra-elements-background-depth-2"
        role="tabpanel"
      ...
      <div className="p-3 border-t border-veyra-elements-borderColor bg-veyra-elements-background-depth-3 space-y-2">
        {/* Bulk CSS section */}
          ...
          <div className="space-y-2 p-2 rounded-lg border border-green-500/30 bg-green-500/5">
            <div className="flex items-center justify-between text-xs">
              ...
              <button
                ...
                className="text-veyra-elements-textTertiary hover:text-red-400 transition-colors"
        ...
        {hasChanges ? (
          <div className="space-y-2">
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 flex items-center justify-center gap-1.5 px-3 py-2 text-xs font-medium rounded-lg border border-veyra-elements-borderColor bg-veyra-elements-background-depth-2 text-veyra-elements-textPrimary hover:bg-veyra-elements-background-depth-4 transition-colors"
              >
          ...
          <p className="text-veyra-elements-textTertiary text-xs text-center">Edit values above to see live changes</p>
        )}
