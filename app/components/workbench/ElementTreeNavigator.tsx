  ...
  ({
    ...
    return (
      <button
        ...
        className={`w-full text-left px-2 py-1.5 text-xs font-mono rounded transition-all flex items-center gap-1.5 ${
          isActive
            ...
            : 'hover:bg-veyra-elements-background-depth-3 text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary'
        }`}
      ...
      >
        ...
        {element.hasChildren && <span className="text-veyra-elements-textTertiary ml-auto">›</span>}
      </button>
    );
  },
);
...
export const ElementTreeNavigator = memo(({ hierarchy, onSelectElement }: ElementTreeNavigatorProps) => {
  ...
  if (!hierarchy || !hierarchy.current) {
    return (
      <div className="text-center py-8 text-veyra-elements-textTertiary text-xs">
    ...
    <div className="space-y-3">
      ...
      {hierarchy.parents.length > 0 && (
        <div className="space-y-0.5">
          <div className="flex items-center gap-1.5 text-[10px] text-veyra-elements-textTertiary uppercase tracking-wide mb-1">
            <span className="i-ph:arrow-up w-3 h-3" />
            Parents
          </div>
          <div className="border-l-2 border-veyra-elements-borderColor ml-1.5 pl-1">
        ...
        <div className="space-y-0.5">
          <div className="flex items-center justify-between">
            ...
            {hierarchy.totalChildren > hierarchy.children.length && (
              <span className="text-[10px] text-veyra-elements-textTertiary">
      ...
      {hierarchy.siblings.length > 0 && (
        <div className="space-y-0.5">
          ...
          <div className="border-l-2 border-veyra-elements-borderColor ml-1.5 pl-1 opacity-75">
      ...
      <div className="pt-2 border-t border-veyra-elements-borderColor">
        <p className="text-[10px] text-veyra-elements-textTertiary text-center">
