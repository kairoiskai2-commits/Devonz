      ...
      <div>
        ...
        {selectedElement.textContent && (
          <div className="p-3 border-b border-veyra-elements-borderColor">
            <label
              ...
              className="text-xs font-medium text-veyra-elements-textSecondary block mb-1.5"
            >
              Text Content
            </label>
            <textarea
              ...
              className="w-full bg-veyra-elements-background-depth-3 border border-veyra-elements-borderColor rounded px-2 py-2 text-veyra-elements-textPrimary text-sm focus:outline-none focus:border-accent-400 resize-none"
              rows={2}
              placeholder="Enter text content..."
            />
            {(pendingTextEdit || selectedElement.textContent || '').length > 100 && (
              <span className="text-[10px] text-veyra-elements-textTertiary mt-1 block text-right">
        ...
        <div className="p-3 border-b border-veyra-elements-borderColor">
          <button
            ...
            className="w-full flex items-center justify-center gap-1.5 px-2 py-1.5 text-xs font-medium rounded border border-veyra-elements-borderColor bg-veyra-elements-background-depth-3 text-veyra-elements-textSecondary hover:bg-veyra-elements-background-depth-4 hover:text-veyra-elements-textPrimary transition-colors"
          >
        ...
        {selectedElement.colors && selectedElement.colors.length > 0 && (
          <div className="p-3 border-t border-veyra-elements-borderColor">
            <PageColorPalette
