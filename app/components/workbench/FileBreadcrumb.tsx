              ...
              <DropdownMenu.Trigger asChild>
                <span
                  ...
                  className={cn('flex items-center gap-1.5 cursor-pointer shrink-0', {
                    'text-veyra-elements-textTertiary hover:text-veyra-elements-textPrimary': !isActive,
                    'text-veyra-elements-textPrimary underline': isActive,
                    'pr-4': isLast,
                  })}
                    ...
                    >
                      ...
                      >
                        <div className="rounded-lg overflow-hidden">
                          <div className="max-h-[50vh] min-w-[300px] overflow-scroll bg-veyra-elements-background-depth-1 border border-veyra-elements-borderColor shadow-sm rounded-lg">
                            <FileTree
                              files={files}
                              hideRoot
                              rootFolder={path}
                        ...
                        <DropdownMenu.Arrow className="fill-veyra-elements-borderColor" />
                      </motion.div>
                    </DropdownMenu.Content>
                  </DropdownMenu.Portal>
                )}
