...
export const StyleGroup = memo(({ label, icon, defaultOpen = false, children }: StyleGroupProps) => {
  ...
  return (
    <div className="border-b border-veyra-elements-borderColor last:border-b-0">
      <button
        onClick={toggle}
        className="w-full flex items-center gap-2 px-3 py-2.5 text-xs font-medium bg-transparent text-veyra-elements-textSecondary hover:text-veyra-elements-textPrimary hover:bg-veyra-elements-background-depth-3 transition-colors"
