...
export function escapeVeyraArtifactTags(input: string) {
...
export function escapeVeyraAActionTags(input: string) {
  // Regular expression to match devonzArtifact tags and their content
...
export function escapeVeyraTags(input: string) {
  return escapeVeyraArtifactTags(escapeVeyraAActionTags(input));
}
