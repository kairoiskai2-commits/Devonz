...
class PreviewErrorHandler {
  ...
  async handlePreviewMessage(message: {
     ...
     * decide whether to ask Veyra for help. Auto-fix from previews was too aggressive,
   ...
   * Call this when user clicks "Ask Veyra" so the same error can be caught again
   */
  reset(): void {
    this.#recentErrorHashes.clear();
 ...
 * continue to be caught after the user clicks "Ask Veyra".
 */
