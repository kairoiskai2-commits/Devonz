 ...
 * Agent Tools Service
 *
 * This service provides the core tool implementations for Veyra AI Agent Mode.
...
/**
 * Run Command Tool
 * Executes a shell command using the VeyraShell.
...
async function runCommand(params: RunCommandParams): Promise<ToolExecutionResult<RunCommandResult>> {
  ...
  try {
    ...
    const shell = workbench.veyraTerminal;
