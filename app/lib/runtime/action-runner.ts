...
import type { VeyraShell } from '~/utils/shell';
...
export type BaseActionState = VeyraAction & {
...
export type FailedActionState = VeyraAction &
...
export class ActionRunner {
   ...
   * on the server. Much more reliable than the marker-based VeyraShell approach
