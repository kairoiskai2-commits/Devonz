...
export function useDataOperations({
  ...
  const handleExportSettings = useCallback(async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = 'veyra-settings.json';
  ...
  const handleExportSelectedSettings = useCallback(
    async (categoryIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = `veyra-settings-${categoryIds.join('-')}.json`;
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleExportSelectedChats = useCallback(
    async (chatIds: string[]) => {
      ...
      try {
        ...
        const a = document.createElement('a');
        a.href = url;
        a.download = 'veyra-selected-chats.json';
        document.body.appendChild(a);
        a.click();
        document.body.removeChild(a);
        URL.revokeObjectURL(url);
  ...
  const handleDownloadTemplate = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'veyra-api-keys-template.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
  ...
  const handleExportAPIKeys = useCallback(async () => {
    ...
    try {
      ...
      const a = document.createElement('a');
      a.href = url;
      a.download = 'veyra-api-keys.json';
      document.body.appendChild(a);
      a.click();
      document.body.removeChild(a);
      URL.revokeObjectURL(url);
