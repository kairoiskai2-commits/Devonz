...
export class WorkbenchStore {
  ...
  get veyraTerminal() {
    return this.#terminalStore.veyraTerminal;
  }
  get alert() {
   ...
   */
  interruptTerminal() {
    this.#terminalStore.veyraTerminal.interruptExecution();
  }
  ...
  attachVeyraTerminal(terminal: ITerminal) {
    this.#terminalStore.attachVeyraTerminal(terminal);
  }
   ...
   * Each item is checked for a `veyra_event` wrapper key, validated against
